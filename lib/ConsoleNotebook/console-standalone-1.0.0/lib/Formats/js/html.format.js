class HtmlFormat{
    ...
    code(lineNumber,valueCode){
        ...
        let countLtCurlyBracket = this._charUtil.countChar(valueCode,'}');
        ...
        this.builder(`<span class="line-number">${lineNumber} :</span> `+ code +'<br>');

        //WILL EFFECTED THE NEXT METHOD CALL
        let countRtCurlyBracket = this._charUtil.countChar(valueCode,'{');
